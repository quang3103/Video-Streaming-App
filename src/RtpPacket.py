...
class RtpPacket:
	...
	def encode(self, version, padding, extension, cc, seqnum, marker, pt, ssrc, payload):
		...
		#self.timeFromServer = curTime.to_bytes(10, 'big')
		#print('Timestamp:', timestamp)

		header = bytearray(HEADER_SIZE)
		#print("timestamp: {}".format(timestamp.to_bytes(5, 'big')))
		#--------------
		# TO COMPLETE
		#--------------
	...
	def decode(self, byteStream):
		...
		#self.timeFromServer = byteStream[-10::1]
	...
	# def getTimeSend(self):
	# 	return self.timeFromServer

	def getPacket(self):
		"""Return RTP packet."""
		return self.header + self.payload #+ self.timeFromServer
